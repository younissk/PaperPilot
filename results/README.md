...
In production, pipeline results are stored in S3 (`paperpilot-artifacts-{env}-{account}`), not in this repository.
...
3. For production, results go to S3 via the serverless pipeline
