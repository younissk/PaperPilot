...
_openalex_semaphore: Optional[asyncio.Semaphore] = None
...
def _decode_abstract(inverted_index: Optional[Dict[str, List[int]]]) -> Optional[str]:
...
def extract_arxiv_id(link_or_id: str) -> Optional[str]:
...
def extract_openalex_id(work_data: Dict[str, Any]) -> Optional[str]:
