 ...
 * Search endpoints.
 */
export async function startSearch(request: SearchRequest): Promise<SearchResponse> {
 ...
 * Ranking endpoints.
 */
export async function startRanking(request: RankingRequest): Promise<RankingResponse> {
...
export async function getRankingStatus(jobId: string): Promise<RankingResponse> {
 ...
 */
export async function startClustering(request: ClusteringRequest): Promise<ClusteringResponse> {
...
export async function getClusteringStatus(jobId: string): Promise<ClusteringResponse> {
 ...
 * Timeline endpoints.
 */
export async function startTimeline(request: TimelineRequest): Promise<TimelineResponse> {
...
export async function getTimelineStatus(jobId: string): Promise<TimelineResponse> {
 ...
 * Graph endpoints.
 */
export async function startGraph(request: GraphRequest): Promise<GraphResponse> {
 ...
 * Report endpoints.
 */
export async function startReport(request: ReportRequest): Promise<ReportResponse> {
 ...
 * Everything endpoint.
 */
export async function startEverything(request: EverythingRequest): Promise<EverythingResponse> {
...
export async function getEverythingStatus(jobId: string): Promise<EverythingResponse> {
...
export async function getQueryMetadata(query: string): Promise<QueryMetadataResponse> {
  return apiRequest<QueryMetadataResponse>(`${API_ENDPOINTS.results}/${encodeURIComponent(query)}`);
}

export async function getSnowballResults(query: string): Promise<{ query: string; total_accepted: number; papers: Paper[] }> {
...
export async function getEloResults(query: string): Promise<unknown> {
  return apiRequest<unknown>(`${API_ENDPOINTS.results}/${encodeURIComponent(query)}/elo`);
}

export async function getClustersResults(query: string): Promise<unknown> {
  return apiRequest<unknown>(`${API_ENDPOINTS.results}/${encodeURIComponent(query)}/clusters`);
}

export async function getTimelineResults(query: string): Promise<unknown> {
  return apiRequest<unknown>(`${API_ENDPOINTS.results}/${encodeURIComponent(query)}/timeline`);
}

export async function getGraphResults(query: string): Promise<unknown> {
  return apiRequest<unknown>(`${API_ENDPOINTS.results}/${encodeURIComponent(query)}/graph`);
}

export async function getReportResults(query: string): Promise<unknown> {
  return apiRequest<unknown>(`${API_ENDPOINTS.results}/${encodeURIComponent(query)}/report`);
}
